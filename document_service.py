                ...
                try:
                    ...
                    try:
                        if ocr_engine_type == "Pix2Text" and ocr_engine is not None:
                            ...
                            for block in res:
                                ...
                                elif text and block.get(
                                    "box_2d"
                                ):  # fallback if it returns box_2d
                    ...
                    for b in diagrams:
                        try:
                            ...
                            draw.rectangle(
                                [x_min, y_min, x_max, y_max], outline="green", width=3
                            )
                            draw.text(
                    ...
                    slice_obj = {
                        ...
                        "diagram": next(
                            iter(diagram_map.values()), None
                        ),  # Backward-compatible default; full mapping stays in diagram_map
